...
def test_one_language():
    ...
    score(my_seg_encoding='utf-8', score_path='result_file/score/score_uni_gram.txt',std_seg_encoding='utf-8',
          std_seg_path='result_file/data/std_k.txt',my_seg_path='result_file/seg/uni_gram.txt')


# 测试二元文法+未登录词识别
def test_two_language():
    Train_Args.tag_doc()  # 对训练文本重新进行训练，并将训练得到的参数写入文本文件中
    ...
    score(my_seg_encoding='utf-8', score_path='result_file/score/score_bi_gram.txt',
                 std_seg_encoding='utf-8', std_seg_path='result_file/data/std_k.txt',
...
if __name__ == '__main__':
    test_one_language()  # 测试一元文法+未登录词识别
